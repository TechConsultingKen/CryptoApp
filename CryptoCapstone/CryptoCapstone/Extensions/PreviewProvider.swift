...
class DeveloperPreview {
    ...
    let stat1 = StatsModel(title: "Market Cap", value: "$12.3Bn", percentageChange: 23.42)
    let stat2 = StatsModel(title: "TotalVolume", value: "$1.32Tr")
    let stat3 = StatsModel(title: "Portfolio Value", value: "$50.4k" , percentageChange: -12.34)
